...
2. [x] Kafka Producer and Consumer Infrastructure — Create KafkaJS service module with connection management, producer instance, and consumer group setup for all four topics `S`
